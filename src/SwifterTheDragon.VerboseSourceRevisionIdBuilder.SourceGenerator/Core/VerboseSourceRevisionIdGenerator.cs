                    ...
                    sourceProductionContext.AddSource(
                        ...
                        sourceText: SourceText.From(
                            text: GeneratorHelper.MakeAutoGeneratedCodeHeader()
                                + "\n// Copyright SwifterTheDragon, and the SwifterTheDragon."
                                + "VerboseSourceRevisionIdBuilder contributors, 2024-2025. All Rights Reserved.\n"
                                + "// SPDX-License-Identifier: MIT\n\n"
                                ...
                                + "\n{\n"
                                + "    /// <summary>\n"
                                + "    /// This class is incrementally source generated by \"<c>"
                                + GeneratorHelper.ToolName
                                + "</c>\".\n"
                                + "    /// </summary>\n"
                                + "    [GeneratedCode(\n"
                                + "        tool: \""
                                ...
                                + "\",\n"
                                + "        version: \""
                                + GeneratorHelper.ToolVersion
                                + "\")]\n"
                                + "    internal static class "
                                + configuration.generatedTypeName
                                + "\n    {\n"
                                + "        /// <summary>\n"
                                + "        /// The current verbose source revision ID,\n"
                                + "        /// incrementally generated by \"<c>"
                                + GeneratorHelper.ToolName
                                + "</c>\".\n"
                                + "        /// </summary>\n"
